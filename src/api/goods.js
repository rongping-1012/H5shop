...
const goodsApi = createApi('goods')
...
// 以下接口可直接切换到真实接口：将 goodsApi 调用替换 mock Promise
...
export const getGoodsDetail = (id) => {
  return Promise.resolve({
    code: 200,
    data: mockGoods.find((item) => item.id === Number(id)) || mockGoods[0]
  })
}
...
export const getGoodsByCategory = (categoryId) => {
